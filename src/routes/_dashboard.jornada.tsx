...
import { TournamentCard } from "@/components/jornada/TournamentCard"

export const Route = createFileRoute("/_dashboard/jornada")({ component: JornadaPage })
        ...
        {user === undefined || active === undefined ? (
          ...
          <div className="mx-auto grid max-w-[1200px] grid-cols-1 gap-6 p-6 lg:grid-cols-3">
            ...
            <aside className="flex flex-col gap-5">
              <TournamentCard sessionId={active.session._id} />
